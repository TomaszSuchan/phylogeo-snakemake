...
- `construct`, `dapc` maps, `spca`, `mapi`, population maps, ancestry maps, pixy maps, and other geographic outputs need `popdata` with usable coordinates.
