...
Per-project analysis flags include `structure`, `faststructure`, `admixture`, `evaladmix`, `tess3`, `snmf`, `construct`, `treemix`, `dapc`, `spca`, `pcaone`, `pcaone_emu`, `pcaone_miss`, `emupca`, `vcf2pcacluster`, `gen_dist`, `pcoa`, `neighbornet`, `mapi`, `pixy`, `genome_scan`, `relatedness`, `roh`, `amova`, `iqtree`, `iqtree_trimal`, `iqtree_robust`, and `fineradstructure`. Set a flag to `true` to request that module's final outputs.
