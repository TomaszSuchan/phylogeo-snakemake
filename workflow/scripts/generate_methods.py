...
if analyses.get("alstructure", False):
    ...
    struct_parts.append(
        ...
        f"imputed by per-locus means within ALStructure (the package default, "
        f"required for the spectral estimation algorithm). ALStructure estimates "
        f"the latent admixture subspace "
