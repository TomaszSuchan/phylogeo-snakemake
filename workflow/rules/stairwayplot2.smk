...
Consumes the folded SFS built in easysfs.smk. Each population is run in its own
self-contained work directory: results/{project}/stairwayplot2/work/{project}.{stratum}/
"""
...
rule stairwayplot2_blueprint:
    ...
    output:
        blueprint="results/{project}/stairwayplot2/work/{project}.{stratum}/{project}.{stratum}.blueprint",
        stats="results/{project}/stairwayplot2/{project}.{stratum}.sfs_stats.tsv",
    params:
        ...
        random_seed=lambda wildcards: config["projects"][wildcards.project]["parameters"]["stairwayplot2"].get("random_seed", None),
    ...
    log:
        "logs/{project}/stairwayplot2_blueprint.{stratum}.log"
    benchmark:
        "benchmarks/{project}/stairwayplot2_blueprint_{stratum}.txt"
    conda:
        "../envs/stairwayplot2.yaml"
    threads: 1
    resources:
...
rule stairwayplot2_run:
    ...
    output:
        summary="results/{project}/stairwayplot2/work/{project}.{stratum}/run/{project}_{stratum}.final.summary",
    params:
        stairway_plot_dir=os.path.abspath(".snakemake/stairwayplot2/stairway_plot_es"),
    log:
        "logs/{project}/stairwayplot2_run.{stratum}.log"
    benchmark:
        "benchmarks/{project}/stairwayplot2_run_{stratum}.txt"
    conda:
        "../envs/stairwayplot2.yaml"
...
rule stairwayplot2_parse_summary:
    ...
    output:
        tsv="results/{project}/stairwayplot2/{project}.{stratum}.ne.tsv",
    params:
        year_per_generation=lambda wildcards: config["projects"][wildcards.project]["parameters"]["stairwayplot2"]["year_per_generation"],
    log:
        "logs/{project}/stairwayplot2_parse_summary.{stratum}.log"
    benchmark:
        "benchmarks/{project}/stairwayplot2_parse_summary_{stratum}.txt"
    conda:
        "../envs/stairwayplot2.yaml"
    threads: 1
    resources:
...
rule stairwayplot2_plot_ne:
    ...
    output:
        pdf="results/{project}/stairwayplot2/plots/{project}.{stratum}.stairwayplot2_ne.pdf",
        rds="results/{project}/stairwayplot2/plots/{project}.{stratum}.stairwayplot2_ne.rds",
        pdf_linear="results/{project}/stairwayplot2/plots/{project}.{stratum}.stairwayplot2_ne_linear.pdf",
        rds_linear="results/{project}/stairwayplot2/plots/{project}.{stratum}.stairwayplot2_ne_linear.rds",
        pdf_xlinear_ylog="results/{project}/stairwayplot2/plots/{project}.{stratum}.stairwayplot2_ne_xlinear_ylog.pdf",
        rds_xlinear_ylog="results/{project}/stairwayplot2/plots/{project}.{stratum}.stairwayplot2_ne_xlinear_ylog.rds",
    params:
    ...
    log:
        "logs/{project}/stairwayplot2_plot_ne.{stratum}.log"
    benchmark:
        "benchmarks/{project}/stairwayplot2_plot_ne_{stratum}.txt"
    conda:
        "../envs/r-plot.yaml"
    threads: 1
    resources:
...
rule stairwayplot2_plot_ne_combined:
    input:
        ne=lambda wildcards: _stairwayplot2_ne_files(wildcards.project),
        populations=rules.easysfs_prepare_samples.output.populations,
    output:
        pdf="results/{project}/stairwayplot2/plots/{project}.stairwayplot2_ne_combined.pdf",
        rds="results/{project}/stairwayplot2/plots/{project}.stairwayplot2_ne_combined.rds",
        pdf_linear="results/{project}/stairwayplot2/plots/{project}.stairwayplot2_ne_combined_linear.pdf",
        rds_linear="results/{project}/stairwayplot2/plots/{project}.stairwayplot2_ne_combined_linear.rds",
        pdf_xlinear_ylog="results/{project}/stairwayplot2/plots/{project}.stairwayplot2_ne_combined_xlinear_ylog.pdf",
        rds_xlinear_ylog="results/{project}/stairwayplot2/plots/{project}.stairwayplot2_ne_combined_xlinear_ylog.rds",
    params:
        out_dir=lambda wildcards: f"results/{wildcards.project}/stairwayplot2",
        ...
        legend_title=lambda wildcards: config["projects"][wildcards.project]["parameters"]["easysfs"].get(
            "population_column", "Population"
        ),
        group_colors=lambda wildcards: _easysfs_group_setting(
            wildcards.project,
    ...
    log:
        "logs/{project}/stairwayplot2_plot_ne_combined.log"
    benchmark:
        "benchmarks/{project}/stairwayplot2_plot_ne_combined.txt"
    conda:
        "../envs/r-plot.yaml"
    threads: 1
    resources:
...
rule stairwayplot2_collect_summary:
    ...
    output:
        summary="results/{project}/stairwayplot2/{project}.stairwayplot2_summary.tsv",
    log:
        "logs/{project}/stairwayplot2_collect_summary.log"
    benchmark:
        "benchmarks/{project}/stairwayplot2_collect_summary.txt"
    conda:
        "../envs/stairwayplot2.yaml"
    threads: 1
    resources:
